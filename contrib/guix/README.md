# Bootstrappable Auroracoin Builds

This directory contains the files necessary to perform bootstrappable Auroracoin
builds.
...
- 24GB of free disk space on the partition that the auroracoin repository resides in
...
For an Auroracoin depends development environment, simply invoke
...
From the top of a clean Auroracoin repository:
...
To use dongcarl's substitute server for Auroracoin builds after having
