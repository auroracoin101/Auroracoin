...
class TestNode():
    ...
    def __init__(self, i, datadir, *, rpchost, timewait, auroracoind, auroracoin_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False):
        """
        Kwargs:
