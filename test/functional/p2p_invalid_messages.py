...
class InvalidMessagesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        if [s for s in os.environ.get("AURORACOIN_CONFIG", "").split(" ") if "--with-sanitizers" in s and "address" in s]:
    ...
    def test_magic_bytes(self):
        ...
        conn._on_data = lambda: None  # Need to ignore all incoming messages from now, since they come with "invalid" magic byte
