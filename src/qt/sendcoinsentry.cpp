    ...
    platformStyle(_platformStyle)
{
    ...
    // normal auroracoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying auroracoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &AuroracoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
