...
//! Entry point for AuroracoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AuroracoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AuroracoinGUI tests.
void AppTests::guiTests(AuroracoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AuroracoinGUI::consoleShown, this, &AppTests::consoleTests);
