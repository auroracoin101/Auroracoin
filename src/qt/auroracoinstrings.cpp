...
QT_TRANSLATE_NOOP("auroracoin-core", "Information"),
...
QT_TRANSLATE_NOOP("auroracoin-core", "Wallet %s resides outside wallet directory %s"),
QT_TRANSLATE_NOOP("auroracoin-core", "Wallet needed to be rewritten: restart %s to complete"),
QT_TRANSLATE_NOOP("auroracoin-core", "Warning"),
