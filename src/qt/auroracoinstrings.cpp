...
QT_TRANSLATE_NOOP("auroracoin-core", "Keypool ran out, please call keypoolrefill first"),
...
QT_TRANSLATE_NOOP("auroracoin-core", "Transaction too large for fee policy"),
