...
QT_TRANSLATE_NOOP("auroracoin-core", "%d of last 100 blocks have unexpected version"),
QT_TRANSLATE_NOOP("auroracoin-core", "%s corrupt, salvage failed"),
QT_TRANSLATE_NOOP("auroracoin-core", "%s is set very high!"),
QT_TRANSLATE_NOOP("auroracoin-core", "-maxmempool must be at least %d MB"),
QT_TRANSLATE_NOOP("auroracoin-core", "Cannot downgrade wallet"),
...
QT_TRANSLATE_NOOP("auroracoin-core", "Error reading from database, shutting down."),
...
QT_TRANSLATE_NOOP("auroracoin-core", "Error: Disk space is too low!"),
...
QT_TRANSLATE_NOOP("auroracoin-core", "Importing..."),
QT_TRANSLATE_NOOP("auroracoin-core", "Incorrect or no genesis block found. Wrong datadir for network?"),
QT_TRANSLATE_NOOP("auroracoin-core", "Initialization sanity check failed. %s is shutting down."),
QT_TRANSLATE_NOOP("auroracoin-core", "Insufficient funds"),
QT_TRANSLATE_NOOP("auroracoin-core", "Invalid -onion address or hostname: '%s'"),
QT_TRANSLATE_NOOP("auroracoin-core", "Invalid -proxy address or hostname: '%s'"),
QT_TRANSLATE_NOOP("auroracoin-core", "Invalid P2P permission: '%s'"),
QT_TRANSLATE_NOOP("auroracoin-core", "Invalid amount for -%s=<amount>: '%s'"),
QT_TRANSLATE_NOOP("auroracoin-core", "Invalid amount for -discardfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("auroracoin-core", "Invalid amount for -fallbackfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("auroracoin-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("auroracoin-core", "Invalid netmask specified in -whitelist: '%s'"),
QT_TRANSLATE_NOOP("auroracoin-core", "Loading P2P addresses..."),
QT_TRANSLATE_NOOP("auroracoin-core", "Loading banlist..."),
QT_TRANSLATE_NOOP("auroracoin-core", "Loading block index..."),
QT_TRANSLATE_NOOP("auroracoin-core", "Loading wallet..."),
QT_TRANSLATE_NOOP("auroracoin-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("auroracoin-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("auroracoin-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("auroracoin-core", "Prune mode is incompatible with -blockfilterindex."),
QT_TRANSLATE_NOOP("auroracoin-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("auroracoin-core", "Pruning blockstore..."),
QT_TRANSLATE_NOOP("auroracoin-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
...
QT_TRANSLATE_NOOP("auroracoin-core", "Specified -walletdir \"%s\" is not a directory"),
...
QT_TRANSLATE_NOOP("auroracoin-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("auroracoin-core", "This is the transaction fee you will pay if you send a transaction."),
QT_TRANSLATE_NOOP("auroracoin-core", "Transaction amount too small"),
QT_TRANSLATE_NOOP("auroracoin-core", "Transaction amounts must not be negative"),
QT_TRANSLATE_NOOP("auroracoin-core", "Transaction fee and change calculation failed"),
QT_TRANSLATE_NOOP("auroracoin-core", "Transaction has too long of a mempool chain"),
QT_TRANSLATE_NOOP("auroracoin-core", "Transaction must have at least one recipient"),
...
QT_TRANSLATE_NOOP("auroracoin-core", "Unknown -blockfilterindex value %s."),
QT_TRANSLATE_NOOP("auroracoin-core", "Unknown address type '%s'"),
QT_TRANSLATE_NOOP("auroracoin-core", "Unknown change type '%s'"),
...
QT_TRANSLATE_NOOP("auroracoin-core", "User Agent comment (%s) contains unsafe characters."),
QT_TRANSLATE_NOOP("auroracoin-core", "Verifying blocks..."),
QT_TRANSLATE_NOOP("auroracoin-core", "Verifying wallet(s)..."),
QT_TRANSLATE_NOOP("auroracoin-core", "Wallet needed to be rewritten: restart %s to complete"),
QT_TRANSLATE_NOOP("auroracoin-core", "Warning: unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("auroracoin-core", "Zapping all transactions from wallet..."),
};
