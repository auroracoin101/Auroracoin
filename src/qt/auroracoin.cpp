...
static void SetupUIArgs()
{
    ...
    gArgs.AddArg("-uiplatform", strprintf("Select platform to customize UI for (one of windows, macosx, other; default: %s)", AuroracoinGUI::DEFAULT_UIPLATFORM), ArgsManager::ALLOW_ANY, true, OptionsCategory::GUI);
}
