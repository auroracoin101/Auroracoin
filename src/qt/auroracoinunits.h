...
#ifndef AURORACOIN_QT_AURORACOINUNITS_H
#define AURORACOIN_QT_AURORACOINUNITS_H
...
/** Auroracoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AuroracoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AuroracoinUnits(QObject *parent);
...
typedef AuroracoinUnits::Unit AuroracoinUnit;

#endif // AURORACOIN_QT_AURORACOINUNITS_H
