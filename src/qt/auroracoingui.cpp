...
void AuroracoinGUI::createActions()
{
    ...
    connect(overviewAction, &QAction::triggered, this, static_cast<void (AuroracoinGUI::*)()>(&AuroracoinGUI::showNormalIfMinimized));
    connect(overviewAction, &QAction::triggered, this, &AuroracoinGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, this, static_cast<void (AuroracoinGUI::*)()>(&AuroracoinGUI::showNormalIfMinimized));
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(sendCoinsMenuAction, &QAction::triggered, this, static_cast<void (AuroracoinGUI::*)()>(&AuroracoinGUI::showNormalIfMinimized));
    connect(sendCoinsMenuAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, this, static_cast<void (AuroracoinGUI::*)()>(&AuroracoinGUI::showNormalIfMinimized));
    connect(receiveCoinsAction, &QAction::triggered, this, &AuroracoinGUI::gotoReceiveCoinsPage);
    connect(receiveCoinsMenuAction, &QAction::triggered, this, static_cast<void (AuroracoinGUI::*)()>(&AuroracoinGUI::showNormalIfMinimized));
    connect(receiveCoinsMenuAction, &QAction::triggered, this, &AuroracoinGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, this, static_cast<void (AuroracoinGUI::*)()>(&AuroracoinGUI::showNormalIfMinimized));
