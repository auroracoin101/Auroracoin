...
#ifndef AURORACOIN_QT_AURORACOINGUI_H
#define AURORACOIN_QT_AURORACOINGUI_H
...
/**
  Auroracoin GUI main class. This class represents the main window of the Auroracoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AuroracoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a auroracoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // AURORACOIN_QT_AURORACOINGUI_H
