...
// TODO: Bitpay code, move to its correct place within this file.
           ...
           RPCHelpMan{"getblockhashes",
                "\nReturns array of hashes of blocks within the timestamp range provided.\n",
                {
                    ...
                    {"capabilities", RPCArg::Type::ARR, /* opt */ true, /* default_val */ "", "A list of strings",
                       {
                       {"noOrphans", RPCArg::Type::BOOL, /* opt */ true, /* default_val */ "", "Will only include blocks on the main chain."},
                       {"logicalTimes", RPCArg::Type::BOOL, /* opt */ true, /* default_val */ "", "Will include logical timestamps with hashes."},
                       },
                    "capabilities"},
                }}
                .ToString() +
            ...
            + HelpExampleCli("getblockhashes", "1231614698 1231024505") + HelpExampleCli("getblockhashes", "1231614698 1231024505 '{\"noOrphans\":false, \"logicalTimes\":true}'") + HelpExampleRpc("getblockhashes", "1231614698, 1231024505")
...
// TODO: Bitpay code, check if this could go to a better place.
...
UniValue getblockchaininfo(const JSONRPCRequest& request)
{
    ...
    UniValue algodiff(UniValue::VNUM);
    ...
    for (int algo = 0; algo < NUM_ALGOS_IMPL; algo++)
    {
        ...
        {
            algodiff.setFloat((double)GetDifficulty(NULL, algo));
            difficulties.pushKV(GetAlgoName(algo), algodiff);
        }
    }
