...
#ifndef AURORACOIN_WALLET_WALLET_H
#define AURORACOIN_WALLET_WALLET_H
...
static const bool DEFAULT_DISABLE_DANDELION = true;
...
enum WalletFlags : uint64_t {
    ...
    //! auroracoin from opening the wallet, thinking it was newly created, and
...
public:
     ...
     * on this auroracoin node, and set to 0 for transactions that were created
...
#endif // AURORACOIN_WALLET_WALLET_H
