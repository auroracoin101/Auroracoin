...
#ifndef AURORACOIN_INTERFACES_NODE_H
#define AURORACOIN_INTERFACES_NODE_H
...
//! Top-level interface for an auroracoin node (auroracoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // AURORACOIN_INTERFACES_NODE_H
