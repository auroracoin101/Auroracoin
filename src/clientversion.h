...
#ifndef AURORACOIN_CLIENTVERSION_H
#define AURORACOIN_CLIENTVERSION_H
...
/**
 * auroracoind-res.rc includes this file, but it cannot cope with real c++ code.
...
#endif // AURORACOIN_CLIENTVERSION_H
