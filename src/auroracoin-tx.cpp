...
static void SetupAuroracoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " auroracoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  auroracoin-tx [options] <hex-tx> [commands]  Update hex-encoded auroracoin transaction\n" +
            "or:     auroracoin-tx [options] -create [commands]   Create hex-encoded auroracoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded auroracoin transaction
