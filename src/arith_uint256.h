...
#ifndef AURORACOIN_ARITH_UINT256_H
#define AURORACOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Auroracoin only uses this "compact" format for encoding difficulty
...
#endif // AURORACOIN_ARITH_UINT256_H
