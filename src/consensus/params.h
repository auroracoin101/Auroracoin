...
#ifndef AURORACOIN_CONSENSUS_PARAMS_H
#define AURORACOIN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    int64_t multiAlgoNum;
    int64_t multiAlgoTimespan;
    ...
    int64_t blockSequentialAlgoMaxCount;
...
#endif // AURORACOIN_CONSENSUS_PARAMS_H
