...
#ifndef AURORACOIN_CHAIN_H
#define AURORACOIN_CHAIN_H
...
// TODO: Bitpay KeyIndex code, needs to go to it's own file at some point, could maybe also be refactorred a bit.
