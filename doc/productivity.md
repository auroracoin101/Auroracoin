...
```sh
make src/auroracoind src/auroracoin-cli
make src/qt/auroracoin-qt
make -C src auroracoin_bench
```
...
Usage is exactly the same as [`clang-format-diff.py`](#format-ccprotobuf-diffs-with-clang-format-diffpy). You can get it [here](https://github.com/MarcoFalke
...
[remote "upstream-pull"]
        ...
        url = git@github.com:aurarad/Auroracoin.git
```
