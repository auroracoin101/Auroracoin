...
the user running auroracoind to the same group and setting permissions appropriately. On
Debian-based systems the user running digibyted can be added to the debian-tor group,
which has the appropriate permissions. Before starting auroracoind you will need to re-login
