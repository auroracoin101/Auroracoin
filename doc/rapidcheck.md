# RapidCheck property-based testing for Auroracoin

## Concept

Property-based testing is experimentally being added to Auroracoin with
...
If RapidCheck is installed, Auroracoin will automatically run the
...
3. Configure Auroracoin with RapidCheck.

    `cd` to the directory of your local auroracoin repository and run
...
4. Build Auroracoin with RapidCheck.
    ...
    Making all in src
    [...]
    CXX      test/gen/test_auroracoin-crypto_gen.o
    CXX      test/test_auroracoin-key_properties.o
    ```
...
That's it! You are now running property-based tests in Auroracoin.