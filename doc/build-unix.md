...
Note
---------------------
Always use absolute paths to configure and compile Auroracoin and the dependencies.
...
+To build Auroracoin without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
As mentioned above, when maintaining portability of the wallet between the standard Auroracoin distributions and independently built
